...
public class FlappyStats extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Average score (last 20 games): " + average(), getWidth() / 2 - 300, getHeight() / 2 - 100);
		g.drawString("High score (last 20 games): " + max(), getWidth() / 2 - 300, getHeight() / 2 - 200);
		g.drawString("Median score (last 20 games): " + median(), getWidth() / 2 - 300, getHeight() / 2);
		g.drawString("Standard Deviation (last 20 games): " + standardDev(), getWidth() / 2 - 300, getHeight() / 2 + 100);
	}
